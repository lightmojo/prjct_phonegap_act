...
document.addEventListener('deviceready', function() {
  ...
  //
  window.plugins.GCM.register("711515244061", "GCM_Event", GCM_Success, GCM_Fail );
  ...
  case 'registered':
    ...
    if ( gApp.gcmregid.length > 0 )
    {
      ...
      // This is where you would code to send the REGID to your server for this device
       $.ajax(
          {
              url: 'http://23.229.116.181/act/api/insert_id.php',
              ...
              error:function (data) {
                 // alert('Some Error Occured When Connecting To Server');
              }
          }
      );
      //
